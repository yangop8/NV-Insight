...
- [x] OpenAI's New GPT-5.5 Powers Codex on NVIDIA Infrastructure (2026-04-24)
...
## nvidia.cn/networking/ethernet-switching 产品基线（2026-04-27）

> 2026-04-27 检查：页面返回 403，通过网络搜索对比未发现产品线变更，基线保持不变。
