...
- [x] Pretrained to Imagine, Fine-Tuned to Act: The Rise of World-Action Models (2026-06-12，06-21 回溯补录，WAM=预训练世界/视频骨干+领域后训练直接输出动作策略，基于 Cosmos 3)

## nvidia.cn/networking/ethernet-switching 产品基线（2026-05-31）

> 2026-06-21 检查：nvidia.cn 网络交换页面仍返回 403，经 WebSearch 间接确认 Spectrum-6（SN6810 102.4T / SN6800 409.6T，2026 下半年上市）产品线无新增型号变更，维持原基线（状态同 06-20）。06-19（周五）至 06-21（周日）blogs.nvidia.com 与 developer.nvidia.com 无 06-19~06-21 净新增博文：blogs 最新仍为 06-18「GFN Thursday: '007 First Light'」已追踪内容；developer 最新仍为 06-16「MLPerf Training 6.0」「ACE Game Agent SDK」等已追踪内容。回溯比对 developer.nvidia.com 发现一篇 06-12 发布、此前检查窗口未捕获的净新增技术博文「Pretrained to Imagine, Fine-Tuned to Act: The Rise of World-Action Models」（WAM 范式：以预训练世界/视频骨干为起点经领域后训练直接输出动作策略，基于 Cosmos 3 全栈开源），按 URL 去重规则补录分析。生成 2026-06-21.md（净新增 1 篇）。
